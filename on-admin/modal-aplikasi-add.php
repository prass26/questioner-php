...
<div class="panel-body">
	<div class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea name="sub" class="form-control" rows="3"></textarea>
			</div>
		</div>
		<div class="hr-dashed"></div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea name="pertanyaan" class="form-control" rows="3" required autocomplete="off"></textarea>
			</div>
		</div>
		<div class="hr-dashed"></div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea name="pil1" class="form-control" rows="3"></textarea>
			</div>
		</div>
		<div class="hr-dashed"></div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea name="pil2" class="form-control" rows="3"></textarea>
			</div>
		</div>
        <div class="hr-dashed"></div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea name="pil3" class="form-control" rows="3"></textarea>
			</div>
		</div>
        <div class="hr-dashed"></div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea name="pil4" class="form-control" rows="3"></textarea>
			</div>
		</div>
        <div class="hr-dashed"></div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea name="pil5" class="form-control" rows="3"></textarea>
			</div>
		</div>
        <div class="hr-dashed"></div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea name="pil6" class="form-control" rows="3"></textarea>
			</div>
		</div>
		<div class="hr-dashed"></div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<select class="form-control" name="kategori">
					<option>Kuesioner Aplikasi</option>
				</select>
			</div>
		</div>
		<div class="hr-dashed"></div>
