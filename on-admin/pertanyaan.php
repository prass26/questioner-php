...
<head>
	...
	<title>Kuesioner - Admin Data Pertanyaan</title>
...
<body>
	...
	<div class="ts-main-content">
		<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li class="open"><a href="#"><i class="fa fa-desktop"></i> Data</a>
					<ul>
						<li><a href="pertanyaan.php">Data Pertanyaan</a></li>
						<li class="open"><a href="jawaban.php">Data Jawaban</a></li>
					</ul>
				</li>
			</ul>
		</nav>
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title">Data Pertanyaan</h2>
						<div class="row">
						<!-- Table -->
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php
									include '../config.php';
									$query = mysqli_query($dbconnect, "SELECT * FROM pertanyaan");
									$no=1;
								...
								<div class="modal fade" id="modalAdd" tabindex="-1" role="dialog" aria-labelledby="User">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<form class="tagForm" id="tag-form" action="components/pertanyaan/save.php" method="POST" enctype="multipart/form-data">
								...
								<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="User">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<form class="tagForm" id="tag-form" action="components/pertanyaan/update.php" method="POST" enctype="multipart/form-data">
												<div class="modal-body">
													<div class="fetched-data"></div>
												</div>
												<div class="modal-footer">
								...
								<div class="modal fade" id="modalDelete" tabindex="-1" role="dialog" aria-labelledby="User">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<form class="tagForm" id="tag-form" action="components/pertanyaan/delete.php" method="POST" enctype="multipart/form-data">
												<div class="modal-body">
													<div class="fetched-data"></div>
												</div>
												<div class="modal-footer">
    ...
    $(document).ready(function(){
        $('#modalDetail').on('show.bs.modal', function (e) {
            ...
            $.ajax({
            	type : 'post',
                url : 'modal-pertanyaan-detail.php',
    ...
    $(document).ready(function(){
        $('#modalDelete').on('show.bs.modal', function (e) {
            ...
            $.ajax({
            	type : 'post',
                url : 'modal-pertanyaan-hapus.php',
                data :  'id_quest='+ id_t,
                success : function(data){
                $('.fetched-data').html(data);//menampilkan data ke dalam modal
                }
