						...
						<div class="panel panel-default">
							<div class="panel-body">
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php
									include '../config.php';
									$result = mysqli_query($dbconnect, "SELECT id_user, nama, tgl_input, COUNT(*) FROM j_kematangan GROUP BY id_user HAVING (COUNT(id_user)>1)");
									foreach ($result as $row){
										echo "<tr>";
										echo "<td>".$row['id_user']."</td>";
										echo "<td>".$row['nama']."</td>";
										echo "<td>".$row['tgl_input']."</td>";
										echo "<td><a href='detail_kematangan.php?id=".$row['id_user']."'><b>Detail<b></a></td>";
										echo "</tr>";
									}
									?>
									</tbody>
