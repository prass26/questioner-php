...
<body>
	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title">Data Pertanyaan Kuesioner Tingkat Kematangan</h2>
						<div class="row">
						<!-- Table -->
								...
								<div class="modal fade" id="modalAdd" tabindex="-1" role="dialog" aria-labelledby="User">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<form class="tagForm" id="tag-form" action="components/kematangan/save.php" method="POST" enctype="multipart/form-data">
								...
								<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="User">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<form class="tagForm" id="tag-form" action="components/kematangan/update.php" method="POST" enctype="multipart/form-data">
												<div class="modal-body">
													<div class="fetched-data"></div>
												</div>
												<div class="modal-footer">
								...
								<div class="modal fade" id="modalDelete" tabindex="-1" role="dialog" aria-labelledby="User">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<form class="tagForm" id="tag-form" action="components/kematangan/delete.php" method="POST" enctype="multipart/form-data">
												<div class="modal-body">
													<div class="fetched-data"></div>
												</div>
												<div class="modal-footer">
    ...
    $(document).ready(function(){
        $('#modalDetail').on('show.bs.modal', function (e) {
            ...
            $.ajax({
            	type : 'post',
                url : 'modal-kematangan-detail.php',
    ...
    $(document).ready(function(){
        $('#modalDelete').on('show.bs.modal', function (e) {
            ...
            $.ajax({
            	type : 'post',
                url : 'modal-kematangan-hapus.php',
                data :  'id_quest='+ id_t,
                success : function(data){
                $('.fetched-data').html(data);//menampilkan data ke dalam modal
                }
