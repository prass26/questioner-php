		...
		<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li class="open"><a href="#"><i class="fa fa-desktop"></i> Data</a>
					<ul>
						<li class="open"><a href="pertanyaan.php">Data Pertanyaan</a></li>
						<li><a href="jawaban.php">Data Jawaban</a></li>
					</ul>
				</li>
			</ul>
		</nav>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<a data-toggle="modal" data-target="#modalAdd" class="btn btn-info">Tambah Data</a>
							</div>
							<div class="panel-body">
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php
									include '../config.php';
									$result = mysqli_query($dbconnect, "SELECT berita.*, foto.gambar FROM berita LEFT OUTER JOIN foto ON berita.id_artikel=foto.id_artikel WHERE berita.kategori = 'olahraga' AND berita.status != 'pending' GROUP BY berita.id_artikel");
